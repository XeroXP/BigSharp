...
{
    [TestFixture, Category("BigCmpEqGtGteLtLte")]
    public class BigCmpEqGtGteLtLteTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        public void CmpEqGtGteLtLte()
        {
            ...
            BigTests.IsTrue(n.Eq(n.ToFixed()));
            BigTests.IsTrue(n.Eq(1));
            BigTests.IsTrue(n.Eq("1e+0"));
            BigTests.IsTrue(!n.Eq(-1));
            BigTests.IsTrue(!n.Eq(0.1));
